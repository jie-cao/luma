...
int main(int argc, char** argv) {
    ...
    for (const auto& n : engine.scene().nodes()) {
        auto* item = new QTreeWidgetItem(QStringList(QString::fromStdString(n.name)));
        item->setData(0, Qt::UserRole, QString::fromStdString(n.camera.value_or("")));
