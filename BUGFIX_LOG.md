...
## 2024-12-19 - Gizmo 视觉改进（专业级设计）

### 🎨 改进 #1: 移动 Gizmo 设计（Blender/Unreal 风格）

**问题描述：**
- 原来的 Gizmo 只有简单的线条，和坐标系 Gizmo 没有区别
- 不符合主流 3D 软件的视觉标准
...
**文件修改：**
- `engine/editor/gizmo.h` - `generateRenderData()` 函数完全重写
